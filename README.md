...
The project investigates the predictive power of **Social Determinants of Health (SDoH)** in modeling opioid-related mortality rates for the state of North Carolina. For full analysis, refer to [full project report](./fullReport.pdf).
 ## Project Overview
